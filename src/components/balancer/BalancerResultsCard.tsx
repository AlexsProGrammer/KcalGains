...
type Props = { result: BalancerResult; names: Map<string, string>; foods: Map<string, Food>; targets: { calories: number; protein: number; carbs: number; fat: number; maxBudget?: number }; onLog: () => void }
...
export function BalancerResultsCard({ result, names, foods, targets, onLog }: Props) {
