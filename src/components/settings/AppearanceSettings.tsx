...
import type { AccentName, Density, Locale, ReduceMotion, TodayHero } from '@/types'
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
            ...
            {ACCENT_OPTIONS.map((option) => {
              ...
              return (
                <Button
                  ...
                  onClick={() => void setSetting('accent', option.value as AccentName)}
                >
        ...
        <Field label="Language">
          <SelectInput value={settings.locale} onChange={(event) => void setSetting('locale', event.target.value as Locale)}>
        ...
        <Field label="Density">
          <SelectInput value={settings.density} onChange={(event) => void setSetting('density', event.target.value as Density)}>
        ...
        <Field label="Motion">
          <SelectInput value={settings.reduceMotion} onChange={(event) => void setSetting('reduceMotion', event.target.value as ReduceMotion)}>
        ...
        <Field label="Today hero">
          <SelectInput value={settings.todayHero} onChange={(event) => void setSetting('todayHero', event.target.value as TodayHero)}>
